...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-nP8W4XFI.mjs");
...
var manifest = {
	"a3ea8645d5ba368b96a29bc3a514c86099b314863ca295ce593cdf9c4d317d95": {
		functionName: "fetchTraffic_createServerFn_handler",
		importer: () => import("./sky-data-BNTySCXM.mjs")
	},
	"c386918bf32f379c780c84d503a48ab2b61dabbf3885a8f2fc593728060b3433": {
		functionName: "fetchRoadTraffic_createServerFn_handler",
		importer: () => import("./road-traffic-DhXo-V3u.mjs")
	},
	"caa28eb354777d357597f404230420ca37579b60a4666feeb8fb2f18b0ed9956": {
		functionName: "fetchAtmosphere_createServerFn_handler",
		importer: () => import("./sky-data-BNTySCXM.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Bou3ZE6C.mjs").then((n) => n.t),
